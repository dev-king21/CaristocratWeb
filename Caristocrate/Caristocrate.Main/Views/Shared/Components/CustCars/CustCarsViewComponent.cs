...
namespace Caristocrate.Main.Views.Shared.Components.CustCars
{
    public class CustCarsViewComponent : ViewComponent
    {
        private AppSettings AppSetting { get; set; }
        public string AuthAccessToken { get; set; }

        public CustCarsViewComponent(IOptions<AppSettings> settings, IHttpContextAccessor httpcontext)
        {
