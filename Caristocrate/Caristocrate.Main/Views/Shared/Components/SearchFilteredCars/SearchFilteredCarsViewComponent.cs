...
namespace Caristocrate.Main.Views.Shared.Components.SearchFilteredCars
{
    public class SearchFilteredCarsViewComponent : ViewComponent
    {
        IDataProtector _dataProtector;
        private AppSettings AppSetting { get; set; }
        public string AuthAccessToken { get; set; }

        public SearchFilteredCarsViewComponent(IDataProtectionProvider provider, IOptions<AppSettings> settings, IHttpContextAccessor httpcontext)
        {
        ...
        public GetCars.Response getCars(GetCars.Request requestOBJ)
        {
            ...
            string Request = "?category_id=" + requestOBJ.categoryID.ToString()
                ...
                + "&car_title=" + requestOBJ.searchWord.ToString();
